...
class Member { // 클래스의 이름은 대문자로 시작한다.
	...
	String id;  // 필드(field) , 속성(properties) , 멤버변수 , 벱버
	String password;
	String name;
	String hp;
	String email;
...
public class ClassEx01 {
	...
	public static void main(String[] args) {
		...
		member1.name = "허준";
		member1.hp = "010-4924-0872";
		member1.email = "qwer1234@gmail.com";
		member1.address = "서울";
		...
		member2.name = "준호";
		member2.hp = "010-4923-0871";
		member2.email = "qwer4567@gmail.com";
		member2.address = "경기";
